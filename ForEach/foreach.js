...
function doubleNumber(arr){
    var newArray = [];
    arr.forEach(a=>newArray.push(a*2))
...
function addKeyAndValue(arr,key,value){
    var newObj = {}
    arr.forEach(vvv=>{newObj[Object.keys(vvv) + " = " + vvv.name]
    = key + " = "+ value; 
    });
    return newObj;
}
console.log(addKeyAndValue([{name: 'Elie'}, 
{name: 'Tim'}, {name: 'Matt'}, 
...
console.log( vowel('I Am awesome and so are you'));